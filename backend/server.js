...
const projectRoutes = require('./routes/projectRoutes'); // Import user routes
...
app.use('/api/projects', projectRoutes);// All routes in userRoutes will be prefixed with /api/users
